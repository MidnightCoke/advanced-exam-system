...
<title>Efe Unverdi || Advanced Exam System </title>
...
<!-- Text input-->
<div class="form-group">
  <h3 class="text-center py-2">Sign up to Exam System</h3>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://midnightcoke.github.io/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Efe Ünverdi</a>
    	<h4 style="font-family:'typo' ">efeunverdi27@gmail.com</h4>
		<h4 style="font-family:'typo' ">Hasan Kalyoncu Universty</h4></div></div>
		</p>
      </div>
